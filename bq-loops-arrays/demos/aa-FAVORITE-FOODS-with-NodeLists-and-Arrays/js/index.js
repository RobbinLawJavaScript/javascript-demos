...
demo1.innerText = `Partial String Filter`
...
demo2.innerText = `Drop Down Filter`
...
demo4.innerText = `Copy List Item to Another List`
...
demo5.innerText = `All Combined with Delete from List`
